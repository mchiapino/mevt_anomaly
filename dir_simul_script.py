...
theta_init = mc.rho_nu_to_theta(rho_init, nu_init)
lbda_init = 0.2*np.ones(K_tot)
...
for k in range(n_loop):
    # Minimize in theta
    print 'err label'
    print np.sum(np.argmax(gamma_z_init, axis=1) != y_label[ind_extr])
